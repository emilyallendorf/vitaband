...
/* =========================== HELPER FUNCTIONS ============================= */
static int sht3xdis_write_reg(uint8_t reg, uint8_t value){
    return i2c_reg_write_byte_dt(&i2c_dev, reg, value);
}

static int sht3xdis_read_reg(uint8_t reg, uint8_t *value){
...
/* ============================== PUBLIC API ================================ */
uint8_t sht3xdis_read_temperature(void) {} // TODO

uint8_t sht3xdis_read_humidity(void) {} // TODO